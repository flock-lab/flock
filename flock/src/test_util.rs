...
pub fn arrow_test_data() -> String {
    match get_data_dir("ARROW_TEST_DATA", "./data") {
...
pub fn parquet_test_data() -> String {
    match get_data_dir("PARQUET_TEST_DATA", "./data") {
        Ok(pb) => pb.display().to_string(),
...
///
///  Returns either:
/// The path referred to in `udf_env` if that variable is set and refers to a
/// directory The submodule_data directory relative to CARGO_MANIFEST_PATH
